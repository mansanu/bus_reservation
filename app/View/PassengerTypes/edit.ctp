...
<?php echo $this->Form->create('PassengerType'); ?>
	<fieldset>
		<legend><?php echo __('Edit Passenger Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PassengerType.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PassengerType.id'))); ?></li>
