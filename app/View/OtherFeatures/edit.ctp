...
<?php echo $this->Form->create('OtherFeature'); ?>
	<fieldset>
		<legend><?php echo __('Edit Other Feature'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('OtherFeature.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('OtherFeature.id'))); ?></li>
