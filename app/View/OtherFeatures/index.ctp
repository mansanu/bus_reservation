<div class="otherFeatures index">
	<h2><?php echo __('Other Features'); ?></h2>
	...
	<tr>
		<td><?php echo h($otherFeature['OtherFeature']['id']); ?>&nbsp;</td>
		<td><?php echo h($otherFeature['OtherFeature']['name']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $otherFeature['OtherFeature']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $otherFeature['OtherFeature']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $otherFeature['OtherFeature']['id']), null, __('Are you sure you want to delete # %s?', $otherFeature['OtherFeature']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
