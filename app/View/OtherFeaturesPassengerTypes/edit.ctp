...
<?php echo $this->Form->create('OtherFeaturesPassengerType'); ?>
	<fieldset>
		<legend><?php echo __('Edit Other Features Passenger Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('OtherFeaturesPassengerType.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('OtherFeaturesPassengerType.id'))); ?></li>
